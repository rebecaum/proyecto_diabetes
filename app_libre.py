...
st.set_page_config(page_title="Predicción de Diabetes - Versión Libre")
...
CSV_PATH = "resultados/datos_pacientes_libre.csv"
...
# === INTERFAZ PRINCIPAL ===
st.title("Aplicación de Predicción de Diabetes (Versión Libre)")
st.markdown("Esta versión permite introducir cualquier valor sin restricciones para experimentación o pruebas.")
...
# Inputs sin restricciones pero con ayuda
insulina = st.sidebar.number_input("Insulina (uU/mL)", value=30.5,
    help="Nivel de insulina en sangre. Valores altos pueden indicar resistencia a la insulina.")
pedigri = st.sidebar.number_input("Pedigrí de diabetes (DPF)", value=0.37,
    help="Índice de predisposición genética. Cuanto mayor, mayor riesgo.")
edad = st.sidebar.number_input("Edad", value=29,
    help="Edad del paciente. El riesgo aumenta con la edad.")
embarazos = st.sidebar.number_input("Nº de embarazos", value=3,
    help="Solo mujeres. Puede estar asociado al riesgo de diabetes.")
glucosa = st.sidebar.number_input("Glucosa (mg/dL)", value=117,
    help="Glucosa en ayunas. >125 puede indicar diabetes.")
presion = st.sidebar.number_input("Presión arterial (mm Hg)", value=72,
    help="Presión diastólica. Relacionada con salud metabólica.")
piel = st.sidebar.number_input("Grosor del pliegue cutáneo (mm)", value=23,
    help="Tejido subcutáneo. Relacionado con grasa corporal.")
imc = st.sidebar.number_input("IMC (kg/m²)", value=32.0,
